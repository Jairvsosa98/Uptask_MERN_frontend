...
const ModalFormularioTarea = () => {
    ...
    useEffect(() => {
        if (tarea?._id) {
            ...
            setPrioridad(tarea.prioridad[0])
            return
        }
        setId('')
        setNombre('')
                            ...
                            <div className="sm:flex sm:items-start">
                                <div className="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left w-full">
                                    ...
                                    <form onSubmit={handleSubmit} className='my-10'>
                                        ...
                                        <input type="submit" value={id ? 'Guardar Cambios' : 'Crear Tarea'} className='bg-sky-600 hover:bg-sky-700  w-full p-3 text-white text-sm uppercase font-bold cursor-pointer transition-colors rounded' />
                                    </form>
                                </div>
                            </div>
                        </div>
